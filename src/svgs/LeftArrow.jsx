export default function LeftArrow({fill = "gray"}){
    return (
        <>
            <svg fill={fill} height="20px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
            xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.006 512.006" xmlSpace="preserve">
